    ...
    <div class="form-section">
        <form action="/admin/siswa/<?= $siswa['id'] ?>/update" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" id="nama" name="nama" value="<?= $siswa['nama'] ?>" placeholder="Masukkan nama lengkap" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" id="username" name="username" value="<?= $siswa['username'] ?>" placeholder="Masukkan username" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" id="nis" name="nis" value="<?= $siswa['nis'] ?>" placeholder="Nomor Induk Siswa" required>
            </div>
